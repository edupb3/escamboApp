...
ActiveRecord::Schema.define(version: 20171129144726) do
  ...
  create_table "profile_menbers", force: :cascade do |t|
    t.string   "first_name"
    t.string   "last_name"
    t.date     "birthdate"
    t.integer  "member_id"
  ...
  add_index "profile_menbers", ["member_id"], name: "index_profile_menbers_on_member_id"
